...
Route::get('/category/delete/{id}','CategoryController@deleteCategory')->name('admin.category.delete');
...
Route::get('/update-bulk-status','BulkUpdateStatus@index')->name('admin.bluk.status');
Route::post('/update-bulk-status','BulkUpdateStatus@index')->name('admin.bluk.status');
