				...
				<div class="col-lg-3 col-md-6 col-sm-6">
					...
					<div class="collapse dont-collapse-sm" id="collapse_ft_3">
						<ul class="contacts">
							...
							<li><i class="ti-email"></i><a href="#0">info@bestbizdeal.ca</a></li>
						</ul>
					</div>
				</div>
				<div class="col-lg-3 col-md-6 col-sm-6">
			...
			<div class="row">
				<div class="col-lg-6">
					<ul id="footer-selector">
						...
						<li><img src="<?php echo e(asset('front/img/cards_all.svg')); ?>" alt=""></li>
					</ul>
				</div>
				<div class="col-lg-6">
					<ul id="additional_links">
						...
						<li><span>© 2020 bestbizdeal.ca</span></li>
					</ul>
				</div>
			</div>
		</div>
	</footer><?php /**PATH D:\xampp\htdocs\directory\resources\views/front/layouts/footer.blade.php ENDPATH**/ ?>