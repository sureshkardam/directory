...
class ListingController extends Controller
{
	...
	public function index(Request $request){
	 ...
	 if ($request->isMethod('get')) { 
    	...
    	return view('admin.theme.listing.listing',compact('listings','categories'));
...

 {
	...
	public function create(Request $request){
	 ...
	 if ($request->isMethod('get')) { 
		...
		//$listings=Lisitng::all();
    	return view('admin.theme.listing.create-listing',compact('categories'));
