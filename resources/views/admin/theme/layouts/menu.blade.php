  <nav class="navbar navbar-expand-lg navbar-dark bg-default fixed-top" id="mainNav">
    <a class="navbar-brand" href="{{ route('admin.home') }}"><img src="{{ asset('admin/img/logo.png') }}" data-retina="true" alt="" width="165" height="36"></a>
    ...
    <div class="collapse navbar-collapse" id="navbarResponsive">
      <ul class="navbar-nav navbar-sidenav" id="exampleAccordion">
		...
		<li class="nav-item" data-toggle="tooltip" data-placement="right" title="Import listing">
          <a class="nav-link" href="{{ route('admin.import.list') }}">
		...
		<!--<li class="nav-item" data-toggle="tooltip" data-placement="right" title="Add listing">
          <a class="nav-link" href="{{ route('admin.create.listing') }}">
            <i class="fa fa-fw fa-plus-circle"></i>
		...
		<li class="nav-item" data-toggle="tooltip" data-placement="right" title="My listings">
          ...
          <ul class="sidenav-second-level collapse" id="collapseMylistings">
			...
			<li>
              <a href="{{ route('admin.listing') }}">All <span class="badge badge-pill badge-primary"></span></a>
            </li>
		...
		<li class="nav-item" data-toggle="tooltip" data-placement="right" title="Category">
          ...
          <ul class="sidenav-second-level collapse" id="collapseCategory">
			...
			<li>
              <a href="{{ route('admin.category.list') }}">List All <span class="badge badge-pill badge-primary"></span></a>
            </li>
			
			<li>
              <a href="{{ route('admin.category.create') }}">Create Category <span class="badge badge-pill badge-primary"></span></a>
            </li>
